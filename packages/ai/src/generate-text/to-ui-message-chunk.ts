...
export type ToUIMessageChunkPart<TOOLS extends ToolSet = ToolSet> =
...
/**
 * Converts a single text stream part into a UI message chunk.
 *
...
export function toUIMessageChunk<
  ...
  UI_MESSAGE extends UIMessage = UIMessage,
>(
  part: ToUIMessageChunkPart<TOOLS>,
  {
    tools,
    sendReasoning = true,
    sendSources = false,
